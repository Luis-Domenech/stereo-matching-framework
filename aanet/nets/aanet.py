...
from aanet.nets.feature import (StereoNetFeature, PSMNetFeature, GANetFeature, GCNetFeature,
                          FeaturePyrmaid, FeaturePyramidNetwork)
from aanet.nets.resnet import AANetFeature
from aanet.nets.cost import CostVolume, CostVolumePyramid
from aanet.nets.aggregation import (StereoNetAggregation, GCNetAggregation, PSMNetBasicAggregation,
                              PSMNetHGAggregation, AdaptiveAggregation)
from aanet.nets.estimation import DisparityEstimation
from aanet.nets.refinement import StereoNetRefinement, StereoDRNetRefinement, HourglassRefinement
...
class AANet(nn.Module):
    def __init__(self, max_disp,
        ...
        self.only_cost_volume = only_cost_volume
